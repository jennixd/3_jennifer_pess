...
if($btnDispatchClicked == true) {
	...
	$sql = "INSERT INTO `incident`(`caller_name`, `phone_number`, `incident_type_id`, `incident_location`, 
`incident_desc`, `incident_status_id`, `time_called`) VALUES ('" . $callerName . "','" . $contactNo . "','" . $typeOfIncident . "',
'" . $locationOfIncident . "','" . $descriptionOfIncident . "','" . $incidentStatus . "',now());";
	...
	echo "insertIncidentSuccess:" . $insertIncidentSuccess  . ' sql: ' . $sql . " incident_id:" . $incidentId . "<br>";
	
	$insertDispatchSuccess  = false;
	echo "total car selected:" . count($patrolcarDispatched) . "<br>";
	...
	foreach($patrolcarDispatched as $eachCarId) { 
		...
		echo "insertDispatchSuccess:" . $insertDispatchSuccess  . ' sql: ' . $sql . "<br>";
...
?>
		...
		<form action="<?php echo htmlentities($_SERVER["PHP_SELF"])?>" method="post">
          <div class="form-group row">
			...
			echo $callerName; 
			?>
						<input type="hidden" id="callerName" name="callerName" value="<?php
			echo $callerName; ?>">
					</span>
            </div>
          ...
          <div class="form-group row">
			...
			echo $contactNo;
			?>
			<input type="hidden" id="contactNo" name="contactNo" value="<?php
			echo $contactNo;
			?>">
			</span>
          ...
          <div class="form-group row">
			...
			?>
              <input type="hidden" id="locationOfIncident"
                     name="locationOfIncident" value="<?php
			echo $locationOfIncident;
			?>">
			</span>
            </div>
          ...
          <div class="form-group row">
            ...
            echo $typeOfIncident;
			?>
              <input id="typeOfIncident" type="hidden" name="typeOfIncident" value="<?php
            echo $typeOfIncident;
			?>">
			</span>
          </div>
          ...
          <div class="form-group row">
			...
			?><input name="descriptionOfIncident" type="hidden" id="descriptionOfIncident" value="<?php
            echo $descriptionOfIncident;
			?>">
			</span>
            </div>
		  ...
		  <div class="form-group row">
            <label for="patrolCar" class="col-sm-4 col-form-label">Choose Patrol Car(s)
            </label>
            <div class="col-sm-8">
